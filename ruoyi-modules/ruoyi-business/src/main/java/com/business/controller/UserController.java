...
public class UserController {
    ...
    public R<XcxLoginVo> login(
        @NotBlank(message = "小程序appid不能为空") @RequestParam String appid,
        @NotBlank(message = "小程序code不能为空") @RequestParam String xcxCode) {

        // 根据 appid 获取对应的 secret
        String secret = environment.getProperty("wechat.miniapp.configs." + appid);
        ...
        loginVo.setClientId("xcx-default");
